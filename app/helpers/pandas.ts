...
import { TickerData, TickerDivData, TickerSplitData } from '../interface/tickerInfo';


export const readCSVSync =(ticker:string,exchange:string,timeFrame:"D1"|"W1"|"M1"):TickerData[]=>{
    const rows = [];
