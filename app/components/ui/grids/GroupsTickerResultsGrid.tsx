...
export default function GroupsTickerResultsGrid(props:IProps) {
   const [selectedGroup,setSelectedGroup]=React.useState(props.results[0]?.indexGroup);
   const [rows,setRows]=React.useState([]);
   const [positionsData,setPositionsData]=React.useState([] as IData[]);
